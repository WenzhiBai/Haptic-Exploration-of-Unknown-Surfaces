...
bool fr3_control_publish__msg__touch_tip_wrench__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fr3_control_publish.msg._touch_tip_wrench.TouchTipWrench", full_classname_dest, 56) == 0);
  }
  fr3_control_publish__msg__TouchTipWrench * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of TouchTipWrench */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fr3_control_publish.msg._touch_tip_wrench");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TouchTipWrench");
