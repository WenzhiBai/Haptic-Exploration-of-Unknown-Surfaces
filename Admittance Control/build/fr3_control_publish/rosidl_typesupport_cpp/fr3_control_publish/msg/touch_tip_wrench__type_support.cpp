...
static const _TouchTipWrench_type_support_symbol_names_t _TouchTipWrench_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fr3_control_publish, msg, TouchTipWrench)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fr3_control_publish, msg, TouchTipWrench)),
  }
};
...
{
  return &::fr3_control_publish::msg::rosidl_typesupport_cpp::TouchTipWrench_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fr3_control_publish, msg, TouchTipWrench)() {
  return get_message_type_support_handle<fr3_control_publish::msg::TouchTipWrench>();
}
